...
| `PUT` | `/api/v1/users/:id` | Update user details | AP, WP | - |
| `POST` | `/api/v1/users/:id/activate` | Activate user account | AP, WP | - |
| `POST` | `/api/v1/users/:id/deactivate` | Deactivate user account | AP, WP | - |
